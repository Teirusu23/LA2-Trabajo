...
def serializedATN():
    return [
        ...
        0,0,7,8,6,1,-1,0,8,11,5,3,0,0,9,11,5,4,0,0,10,7,1,0,0,0,10,9,1,0,
        0,0,11,20,1,0,0,0,12,13,10,4,0,0,13,14,5,2,0,0,14,19,3,2,1,5,15,
        16,10,3,0,0,16,17,5,1,0,0,17,19,3,2,1,4,18,12,1,0,0,0,18,15,1,0,
...
class ExprParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "MAS", "Multi", "NUM", "Identificador", 
                      "WS" ]
