...
def serializedATN():
    return [
        ...
        0,8,11,5,2,0,0,9,11,5,3,0,0,10,7,1,0,0,0,10,9,1,0,0,0,11,17,1,0,
        0,0,12,13,10,3,0,0,13,14,5,1,0,0,14,16,3,2,1,4,15,12,1,0,0,0,16,
...
class ExprParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "CompIg", "NUM", "Identificador", "WS" ]
    ...
    class ExprContext(ParserRuleContext):
        ...
        def CompIg(self):
            return self.getToken(ExprParser.CompIg, 0)
