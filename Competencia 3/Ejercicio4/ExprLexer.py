...
def serializedATN():
    return [
        ...
        14,1,0,0,0,5,17,1,0,0,0,7,22,1,0,0,0,9,27,1,0,0,0,11,12,5,105,0,
        0,12,13,5,102,0,0,13,2,1,0,0,0,14,15,5,62,0,0,15,4,1,0,0,0,16,18,
        7,0,0,0,17,16,1,0,0,0,18,19,1,0,0,0,19,17,1,0,0,0,19,20,1,0,0,0,
        ...
        32,10,1,0,0,0,4,0,19,24,29,1,6,0,0
    ]
...
class ExprLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "IF", "Comp", "NUM", "Identificador", "WS" ]

    ruleNames = [ "IF", "Comp", "NUM", "Identificador", "WS" ]
