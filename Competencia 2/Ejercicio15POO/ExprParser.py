...
class ExprParser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'nmap'", "'ss'", "'sudo'", "'tcpdump'", 
                     "'journalctl'", "'dig'", "'ufw'", "'deny'", "'from'", 
                     "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                     "<INVALID>", "<INVALID>", "','", "';'", "'='", "'.'" ]

    symbolicNames = [ "<INVALID>", "NMPAP", "SS", "SUDO", "TCPDUMP", "JOURNALCTL", 
                      "DIG", "UFW", "DENY", "FROM", "IP", "BANDERA_C", "BANDERA_L", 
                      "TIMING", "DOMINIO", "UBICACION_ARCH", "Coma", "PuntoComa", 
