...
class App:
    ...
    def ejecutar(self):
        ...
        st.write("Sube un archivo `.sh` para ver tokens y errores lexicos.")

        archivo_subido = st.file_uploader("Selecciona tu archivo", type=["sh"])

        if archivo_subido is None:
            st.info("Primero sube un archivo .sh")
            return
